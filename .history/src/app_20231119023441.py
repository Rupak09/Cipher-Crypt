...
with st.container():
    ...
    with left_column:
        st.subheader("Hey there! You are now at Cipher Crypt..")
        st.title("Upload and encrypt your image here..")
    with right_column:
  ...
  # Image upload section
    ...
    uploaded_file = st.file_uploader("Choose Images", accept_multiple_files=True, type=['png', 'jpg', 'jpeg'])
