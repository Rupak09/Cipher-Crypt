...
if uploaded_file is not None:
    ...
    # Display an error message if neither encrypted nor decrypted images exist
    if not st.session_state.encrypted_images_exist and not st.session_state.decrypted_images_exist:
        st.error("Please upload and encrypt an image first.")
        image = Image.open(uploaded_file)
